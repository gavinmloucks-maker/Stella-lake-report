...
const GRAB_KEY = [
    { name: "Nose Grab", key: "Leading (front) hand grabs the nose of the board." },
{ name: "Indy", key: "Trailing (back) hand grabs the heelside edge between the bindings." },
{ name: "Tail Grab", key: "Trailing (back) hand grabs the tail of the board." },
...
{ name: "Stalefish", key: "Trailing (back) hand grabs the heelside edge between the bindings." },
{ name: "Slob", key: "Leading (front) hand grabs the toeside edge near the nose." },
{ name: "Method", key: "Leading (front) hand grabs the heelside edge near the nose." },
{ name: "Sad Air", key: "Leading (front) hand grabs the rear toeside edge." },
{ name: "Rocket Air", key: "Both hands grab the nose of the board." },
{ name: "Double Tail Grab", key: "Both hands grab the tail of the board." },
{ name: "Seatbelt", key: "Leading (front) hand reaches across the body to grab the rear heelside edge." },
{ name: "Crail", key: "Trailing (back) hand grabs the nose of the board." },
{ name: "Nuclear", key: "Trailing (back) hand grabs the heelside edge near the nose." },
{ name: "Crail (Edge)", key: "Trailing (back) hand grabs the toeside edge near the nose." },
{ name: "Taipan", key: "Leading (front) hand reaches through the legs to grab the toeside edge between the bindings." },
{ name: "Canadian Bacon", key: "Trailing (back) hand reaches through the legs to grab the toeside edge between the bindings." },
{ name: "Roast Beef", key: "Trailing (back) hand reaches through the legs to grab the heelside edge between the bindings." },
{ name: "Chicken Salad", key: "Trailing (back) hand grabs the heelside edge between the bindings with the arm twisted." },
{ name: "Stelmasky", key: "Leading (front) hand reaches through the legs to grab the heelside edge between the bindings." },
{ name: "Tindy", key: "Trailing (back) hand grabs the rear toeside edge." },
{ name: "Tailfish", key: "Trailing (back) hand grabs the rear heelside edge." },
];
